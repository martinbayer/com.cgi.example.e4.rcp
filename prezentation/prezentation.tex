...
\newcommand{\ice@eg}[1]{\textcolor{ice}{\href{#1}{\@eg}}}
\newcommand{\pmp@eg}[1]{\textcolor{pumpkin}{\href{#1}{\@eg}}}
...
\begin{frame}{Eclipse Rich Client Platform}%<<<
	\begin{itemize}
		...
		\item layout looks like Eclipse IDE \eg{https://github.com/martinbayer/com.cgi.example.e4.rcp}
	\end{itemize}
...
\begin{frame}{Dependency Injection in RCP}%<<<
	\begin{itemize}
		...
		\item annotations \eg{https://github.com/martinbayer/com.cgi.example.e4.rcp}
			\begin{itemize}
...
\begin{frame}{Application Model}%<<<
	\begin{itemize}
		...
		\item elements \eg{https://github.com/martinbayer/com.cgi.example.e4.rcp}
			\begin{itemize}
				\item graphical: window, perspective, part
				\item commands, handlers, menus, tool items
				\item addons (provide services)
			\end{itemize}
		\item can be changed dynamically (\ttt{EModelService}) \eg*{4}
	\end{itemize}
\end{frame}%>>>
\begin{frame}{Commands and Handlers}%<<<
	...
	\begin{itemize}
		\item DI in practice \fig \eg{https://github.com/martinbayer/com.cgi.example.e4.rcp}
			\begin{enumerate}
				\item button calls \str{command}
				\item \str{framework} finds closest \str{handler}
			\end{enumerate}
		\item different ``save'' for different editors
		\item handlers can be called from code \eg*{3}
	\end{itemize}
\end{frame}%>>>
...
\begin{frame}{Eclipse Context}%<<<
	...
	Passing objects \eg{https://github.com/martinbayer/com.cgi.example.e4.rcp}
	\begin{itemize}
...
\begin{frame}{Context Hierarchy}%<<<
	\begin{itemize}
		...
		\item \alert{Use common context for communication!} \eg{https://github.com/martinbayer/com.cgi.example.e4.rcp}
	\end{itemize}
\end{frame}%>>>
...
\begin{frame}{Context vs Event Service}%<<<
	...
	\begin{centerblock}\begin{tabular}{l@{\ $\Rightarrow$\ }l}
		...
		I~need both & use both \eg{https://github.com/martinbayer/com.cgi.example.e4.rcp}\\
	\end{tabular}\end{centerblock}
...
\begin{frame}{Extensions}%<<<
	...
	\end{enumerate}\eg{https://github.com/martinbayer/com.cgi.example.e4.rcp}
\end{frame}%>>>
...
\begin{frame}{Fragments}%<<<
	\begin{itemize}
		...
		\item GUI elements, commands, handlers, \ldots \eg{10}
